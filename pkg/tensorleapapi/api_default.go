...
func (r ApiAnalyzeGraphRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DefaultApiService) AnalyzeGraphExecute(r ApiAnalyzeGraphRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localVarPath := localBasePath + "/jobs/analyzeGraph"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.analyzeGraphParams == nil {
		return nil, reportError("analyzeGraphParams is required and must be specified")
	}
...
type ApiGetStoredExportedSessionRunBlobRequest struct {
	ctx                                          context.Context
	ApiService                                   *DefaultApiService
	getStoredExportedSessionRunResourceUrlParams *GetStoredExportedSessionRunResourceUrlParams
}

func (r ApiGetStoredExportedSessionRunBlobRequest) GetStoredExportedSessionRunResourceUrlParams(getStoredExportedSessionRunResourceUrlParams GetStoredExportedSessionRunResourceUrlParams) ApiGetStoredExportedSessionRunBlobRequest {
	r.getStoredExportedSessionRunResourceUrlParams = &getStoredExportedSessionRunResourceUrlParams
	return r
}

func (r ApiGetStoredExportedSessionRunBlobRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.GetStoredExportedSessionRunBlobExecute(r)
}

/*
GetStoredExportedSessionRunBlob Method for GetStoredExportedSessionRunBlob

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetStoredExportedSessionRunBlobRequest
*/
func (a *DefaultApiService) GetStoredExportedSessionRunBlob(ctx context.Context) ApiGetStoredExportedSessionRunBlobRequest {
	return ApiGetStoredExportedSessionRunBlobRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return string
func (a *DefaultApiService) GetStoredExportedSessionRunBlobExecute(r ApiGetStoredExportedSessionRunBlobRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetStoredExportedSessionRunBlob")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/exportedsessionruns/getStoredExportedSessionRunBlob"
