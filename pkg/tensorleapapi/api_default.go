...
type ApiCreateEquivalentValidationRequest struct {
	ctx                              context.Context
	ApiService                       *DefaultApiService
	createEquivalentValidationParams *CreateEquivalentValidationParams
}

func (r ApiCreateEquivalentValidationRequest) CreateEquivalentValidationParams(createEquivalentValidationParams CreateEquivalentValidationParams) ApiCreateEquivalentValidationRequest {
	r.createEquivalentValidationParams = &createEquivalentValidationParams
	return r
}

func (r ApiCreateEquivalentValidationRequest) Execute() (*CreateEquivalentValidationResponse, *http.Response, error) {
	return r.ApiService.CreateEquivalentValidationExecute(r)
}

/*
CreateEquivalentValidation Method for CreateEquivalentValidation

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateEquivalentValidationRequest
*/
func (a *DefaultApiService) CreateEquivalentValidation(ctx context.Context) ApiCreateEquivalentValidationRequest {
	return ApiCreateEquivalentValidationRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return CreateEquivalentValidationResponse
func (a *DefaultApiService) CreateEquivalentValidationExecute(r ApiCreateEquivalentValidationRequest) (*CreateEquivalentValidationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CreateEquivalentValidationResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateEquivalentValidation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/graph/createEquivalentValidation"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createEquivalentValidationParams == nil {
		return localVarReturnValue, nil, reportError("createEquivalentValidationParams is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createEquivalentValidationParams
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGetCodeIntegrationVersionFromBinderRequest struct {
	ctx                   context.Context
	ApiService            *DefaultApiService
	codeIntegrationBinder *CodeIntegrationBinder
}

func (r ApiGetCodeIntegrationVersionFromBinderRequest) CodeIntegrationBinder(codeIntegrationBinder CodeIntegrationBinder) ApiGetCodeIntegrationVersionFromBinderRequest {
	r.codeIntegrationBinder = &codeIntegrationBinder
	return r
}

func (r ApiGetCodeIntegrationVersionFromBinderRequest) Execute() (*DatasetVersion, *http.Response, error) {
	return r.ApiService.GetCodeIntegrationVersionFromBinderExecute(r)
}

/*
GetCodeIntegrationVersionFromBinder Method for GetCodeIntegrationVersionFromBinder

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetCodeIntegrationVersionFromBinderRequest
*/
func (a *DefaultApiService) GetCodeIntegrationVersionFromBinder(ctx context.Context) ApiGetCodeIntegrationVersionFromBinderRequest {
	return ApiGetCodeIntegrationVersionFromBinderRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultApiService) GetCodeIntegrationVersionFromBinderExecute(r ApiGetCodeIntegrationVersionFromBinderRequest) (*DatasetVersion, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DatasetVersion
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetCodeIntegrationVersionFromBinder")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/versions/getCodeIntegrationVersionFromBinder"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.codeIntegrationBinder == nil {
		return localVarReturnValue, nil, reportError("codeIntegrationBinder is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.codeIntegrationBinder
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiGetGeneratedDashletsRequest struct {
	ctx                        context.Context
	ApiService                 *DefaultApiService
	getGeneratedDashletsParams *GetGeneratedDashletsParams
}

func (r ApiGetGeneratedDashletsRequest) GetGeneratedDashletsParams(getGeneratedDashletsParams GetGeneratedDashletsParams) ApiGetGeneratedDashletsRequest {
	r.getGeneratedDashletsParams = &getGeneratedDashletsParams
	return r
}

func (r ApiGetGeneratedDashletsRequest) Execute() (*GetGeneratedDashletsResponse, *http.Response, error) {
	return r.ApiService.GetGeneratedDashletsExecute(r)
}

/*
GetGeneratedDashlets Method for GetGeneratedDashlets

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetGeneratedDashletsRequest
*/
func (a *DefaultApiService) GetGeneratedDashlets(ctx context.Context) ApiGetGeneratedDashletsRequest {
	return ApiGetGeneratedDashletsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return GetGeneratedDashletsResponse
func (a *DefaultApiService) GetGeneratedDashletsExecute(r ApiGetGeneratedDashletsRequest) (*GetGeneratedDashletsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetGeneratedDashletsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetGeneratedDashlets")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/dashletsGenerator/getGeneratedDashlets"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.getGeneratedDashletsParams == nil {
		return localVarReturnValue, nil, reportError("getGeneratedDashletsParams is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.getGeneratedDashletsParams
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) GetGenericBaseImageTypesExecute(r ApiGetGenericBaseImageTypesRequest) (*GetGenericBaseImageTypesResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/datasetVersions/getGenericBaseImageTypes"
...
func (r ApiImportExternalModelRequest) Execute() (*ExternalImportModelStorageResponse, *http.Response, error) {
...
func (a *DefaultApiService) ImportExternalModelExecute(r ApiImportExternalModelRequest) (*ExternalImportModelStorageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateDatasetRequest) Execute() (*UpdateDatasetResponse, *http.Response, error) {
...
*/
func (a *DefaultApiService) UpdateDataset(ctx context.Context) ApiUpdateDatasetRequest {
	return ApiUpdateDatasetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultApiService) UpdateDatasetExecute(r ApiUpdateDatasetRequest) (*UpdateDatasetResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateDatasetResponse
	)
	...
	localVarPath := localBasePath + "/datasets/updateDataset"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateDatasetParams == nil {
		return localVarReturnValue, nil, reportError("updateDatasetParams is required and must be specified")
	}
