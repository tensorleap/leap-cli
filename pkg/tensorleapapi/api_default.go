...
type ApiGetSessionEpochsRequest struct {
	ctx                     context.Context
	ApiService              *DefaultApiService
	getSessionEpochsRequest *GetSessionEpochsRequest
}

func (r ApiGetSessionEpochsRequest) GetSessionEpochsRequest(getSessionEpochsRequest GetSessionEpochsRequest) ApiGetSessionEpochsRequest {
	r.getSessionEpochsRequest = &getSessionEpochsRequest
	return r
}

func (r ApiGetSessionEpochsRequest) Execute() (*GetSessionEpochsResponse, *http.Response, error) {
	return r.ApiService.GetSessionEpochsExecute(r)
}

/*
GetSessionEpochs Method for GetSessionEpochs

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSessionEpochsRequest
*/
func (a *DefaultApiService) GetSessionEpochs(ctx context.Context) ApiGetSessionEpochsRequest {
	return ApiGetSessionEpochsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultApiService) GetSessionEpochsExecute(r ApiGetSessionEpochsRequest) (*GetSessionEpochsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetSessionEpochs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/versions/getSessionEpochs"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.getSessionEpochsRequest == nil {
		return localVarReturnValue, nil, reportError("getSessionEpochsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.getSessionEpochsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
