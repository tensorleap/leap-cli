...
func (r ApiGetEngineSettingsRequest) Execute() (*GetSettingsWrapper, *http.Response, error) {
...
func (a *DefaultApiService) GetEngineSettingsExecute(r ApiGetEngineSettingsRequest) (*GetSettingsWrapper, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetSettingsWrapper
	)
...
func (r ApiUpdateEngineSettingsRequest) SetSettingValues(setSettingValues SetSettingValues) ApiUpdateEngineSettingsRequest {
	r.setSettingValues = &setSettingValues
	return r
}
...
func (a *DefaultApiService) UpdateEngineSettingsExecute(r ApiUpdateEngineSettingsRequest) (*http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.setSettingValues == nil {
		return nil, reportError("setSettingValues is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.setSettingValues
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
