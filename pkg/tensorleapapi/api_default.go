...
func (r ApiApplyDatasetMappingRequest) Execute() (*ModelGraph, *http.Response, error) {
...
//
//	@return ModelGraph
func (a *DefaultApiService) ApplyDatasetMappingExecute(r ApiApplyDatasetMappingRequest) (*ModelGraph, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
