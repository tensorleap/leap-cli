...
type ApiApplyDatasetBindingRequest struct {
	ctx                       context.Context
	ApiService                *DefaultApiService
	applyDatasetBindingParams *ApplyDatasetBindingParams
}

func (r ApiApplyDatasetBindingRequest) ApplyDatasetBindingParams(applyDatasetBindingParams ApplyDatasetBindingParams) ApiApplyDatasetBindingRequest {
	r.applyDatasetBindingParams = &applyDatasetBindingParams
	return r
}

func (r ApiApplyDatasetBindingRequest) Execute() (*ModelGraph, *http.Response, error) {
	return r.ApiService.ApplyDatasetBindingExecute(r)
}

/*
ApplyDatasetBinding Method for ApplyDatasetBinding

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiApplyDatasetBindingRequest
*/
func (a *DefaultApiService) ApplyDatasetBinding(ctx context.Context) ApiApplyDatasetBindingRequest {
	return ApiApplyDatasetBindingRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ModelGraph
func (a *DefaultApiService) ApplyDatasetBindingExecute(r ApiApplyDatasetBindingRequest) (*ModelGraph, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ModelGraph
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ApplyDatasetBinding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/graph/applyDatasetBinding"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.applyDatasetBindingParams == nil {
		return localVarReturnValue, nil, reportError("applyDatasetBindingParams is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.applyDatasetBindingParams
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiDownloadRequest) Execute() (*http.Response, error) {
...
*/
func (a *DefaultApiService) Download(ctx context.Context, projectId string) ApiDownloadRequest {
	return ApiDownloadRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
// Execute executes the request
func (a *DefaultApiService) DownloadExecute(r ApiDownloadRequest) (*http.Response, error) {
	var (
...
func (r ApiUploadRequest) Description(description string) ApiUploadRequest {
	r.description = &description
	return r
}

func (r ApiUploadRequest) Execute() (*http.Response, error) {
...
*/
func (a *DefaultApiService) Upload(ctx context.Context, projectName string) ApiUploadRequest {
	return ApiUploadRequest{
		ApiService:  a,
		ctx:         ctx,
...
// Execute executes the request
func (a *DefaultApiService) UploadExecute(r ApiUploadRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.Upload")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
