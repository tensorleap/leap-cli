...
type ApiClearStorageRequest struct {
	ctx                 context.Context
	ApiService          *DefaultApiService
	clearStorageRequest *ClearStorageRequest
}

func (r ApiClearStorageRequest) ClearStorageRequest(clearStorageRequest ClearStorageRequest) ApiClearStorageRequest {
	r.clearStorageRequest = &clearStorageRequest
	return r
}

func (r ApiClearStorageRequest) Execute() (*ClearStorageResponse, *http.Response, error) {
	return r.ApiService.ClearStorageExecute(r)
}

/*
ClearStorage Method for ClearStorage

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiClearStorageRequest
*/
func (a *DefaultApiService) ClearStorage(ctx context.Context) ApiClearStorageRequest {
	return ApiClearStorageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultApiService) ClearStorageExecute(r ApiClearStorageRequest) (*ClearStorageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClearStorageResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ClearStorage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/clearStorage"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.clearStorageRequest == nil {
		return localVarReturnValue, nil, reportError("clearStorageRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.clearStorageRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
