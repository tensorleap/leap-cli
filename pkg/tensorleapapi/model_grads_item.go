...
func (o *GradsItem) UnmarshalJSON(data []byte) (err error) {
	...
	varGradsItem := _GradsItem{}

	err = json.Unmarshal(data, &varGradsItem)

	if err != nil {
		return err
	}

	*o = GradsItem(varGradsItem)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "grads")
		delete(additionalProperties, "visualizer_name")
		delete(additionalProperties, "encoder_names")
		delete(additionalProperties, "connection_name")
		delete(additionalProperties, "channel_importance")
