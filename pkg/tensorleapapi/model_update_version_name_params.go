...
type _UpdateVersionNameParams UpdateVersionNameParams
...
func (o *UpdateVersionNameParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateVersionNameParams := _UpdateVersionNameParams{}

	err = json.Unmarshal(data, &varUpdateVersionNameParams)

	if err != nil {
		return err
	}

	*o = UpdateVersionNameParams(varUpdateVersionNameParams)
