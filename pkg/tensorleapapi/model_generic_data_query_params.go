...
type GenericDataQueryParams struct {
	...
	ReferenceStatsField  *string        `json:"referenceStatsField,omitempty"`
...
// GetReferenceStatsField returns the ReferenceStatsField field value if set, zero value otherwise.
func (o *GenericDataQueryParams) GetReferenceStatsField() string {
	if o == nil || IsNil(o.ReferenceStatsField) {
		var ret string
		return ret
	}
	return *o.ReferenceStatsField
}

// GetReferenceStatsFieldOk returns a tuple with the ReferenceStatsField field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GenericDataQueryParams) GetReferenceStatsFieldOk() (*string, bool) {
	if o == nil || IsNil(o.ReferenceStatsField) {
		return nil, false
	}
	return o.ReferenceStatsField, true
}
...
// SetReferenceStatsField gets a reference to the given string and assigns it to the ReferenceStatsField field.
func (o *GenericDataQueryParams) SetReferenceStatsField(v string) {
	o.ReferenceStatsField = &v
}
...
func (o GenericDataQueryParams) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReferenceStatsField) {
		toSerialize["referenceStatsField"] = o.ReferenceStatsField
	}
...
func (o *GenericDataQueryParams) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GenericDataQueryParams(varGenericDataQueryParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "referenceStatsField")
