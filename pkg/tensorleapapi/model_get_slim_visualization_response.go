...
type _GetSlimVisualizationResponse GetSlimVisualizationResponse
...
func (o *GetSlimVisualizationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSlimVisualizationResponse := _GetSlimVisualizationResponse{}

	err = json.Unmarshal(data, &varGetSlimVisualizationResponse)

	if err != nil {
		return err
	}

	*o = GetSlimVisualizationResponse(varGetSlimVisualizationResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "slimVisualization")
