...
type _MultiChartsParams MultiChartsParams
...
func (o *MultiChartsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiChartsParams := _MultiChartsParams{}

	err = json.Unmarshal(data, &varMultiChartsParams)

	if err != nil {
		return err
	}

	*o = MultiChartsParams(varMultiChartsParams)
