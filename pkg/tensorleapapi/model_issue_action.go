...
func (o *IssueAction) UnmarshalJSON(data []byte) (err error) {
	varIssueAction := _IssueAction{}

	err = json.Unmarshal(data, &varIssueAction)

	if err != nil {
		return err
	}

	*o = IssueAction(varIssueAction)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "assignment")
		delete(additionalProperties, "tagsAdded")
