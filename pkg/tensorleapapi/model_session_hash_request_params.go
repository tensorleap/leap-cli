...
type _SessionHashRequestParams SessionHashRequestParams
...
func (o *SessionHashRequestParams) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionHashRequestParams := _SessionHashRequestParams{}
	...
	*o = SessionHashRequestParams(varSessionHashRequestParams)
