...
func (o *SessionTest) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionTest := _SessionTest{}

	err = json.Unmarshal(data, &varSessionTest)

	if err != nil {
		return err
	}

	*o = SessionTest(varSessionTest)
