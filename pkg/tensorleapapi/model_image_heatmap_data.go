...
type _ImageHeatmapData ImageHeatmapData
...
func (o *ImageHeatmapData) UnmarshalJSON(data []byte) (err error) {
	...
	varImageHeatmapData := _ImageHeatmapData{}

	err = json.Unmarshal(data, &varImageHeatmapData)

	if err != nil {
		return err
	}

	*o = ImageHeatmapData(varImageHeatmapData)
