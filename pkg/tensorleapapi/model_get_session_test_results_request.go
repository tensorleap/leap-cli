...
type _GetSessionTestResultsRequest GetSessionTestResultsRequest
...
func (o *GetSessionTestResultsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSessionTestResultsRequest := _GetSessionTestResultsRequest{}

	err = json.Unmarshal(data, &varGetSessionTestResultsRequest)

	if err != nil {
		return err
	}

	*o = GetSessionTestResultsRequest(varGetSessionTestResultsRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "projectId")
		delete(additionalProperties, "sessionsTestData")
