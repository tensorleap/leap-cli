...
type _MetricMessageParams MetricMessageParams
...
func (o *MetricMessageParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricMessageParams := _MetricMessageParams{}

	err = json.Unmarshal(data, &varMetricMessageParams)

	if err != nil {
		return err
	}

	*o = MetricMessageParams(varMetricMessageParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "loss_node_id")
		delete(additionalProperties, "loss_name")
