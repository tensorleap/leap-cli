...
type JobNotificationContext struct {
	...
	JobNotificationProjectContext    *JobNotificationProjectContext
...
func (dst *JobNotificationContext) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal JSON data into JobNotificationProjectContext
	err = json.Unmarshal(data, &dst.JobNotificationProjectContext)
	if err == nil {
		jsonJobNotificationProjectContext, _ := json.Marshal(dst.JobNotificationProjectContext)
		if string(jsonJobNotificationProjectContext) == "{}" { // empty struct
			dst.JobNotificationProjectContext = nil
		} else {
			return nil // data stored in dst.JobNotificationProjectContext, return on the first match
		}
	} else {
		dst.JobNotificationProjectContext = nil
	}
...
func (src JobNotificationContext) MarshalJSON() ([]byte, error) {
	...
	if src.JobNotificationProjectContext != nil {
