...
type _ActivationParams ActivationParams
...
func (o *ActivationParams) UnmarshalJSON(data []byte) (err error) {
	...
	varActivationParams := _ActivationParams{}

	err = json.Unmarshal(data, &varActivationParams)

	if err != nil {
		return err
	}

	*o = ActivationParams(varActivationParams)
