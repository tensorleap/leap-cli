...
type _ExportProjectParams ExportProjectParams
...
func (o *ExportProjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varExportProjectParams := _ExportProjectParams{}

	err = json.Unmarshal(data, &varExportProjectParams)

	if err != nil {
		return err
	}

	*o = ExportProjectParams(varExportProjectParams)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "exportUrl")
		delete(additionalProperties, "projectVersion")
		delete(additionalProperties, "exportOptions")
		delete(additionalProperties, "alreadyExported")
		delete(additionalProperties, "projectExportMeta")
