...
func NewCreateOrganizationRequest(name string, publicName string) *CreateOrganizationRequest {
...
func (o *CreateOrganizationRequest) GetPublicName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateOrganizationRequest) GetPublicNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateOrganizationRequest) SetPublicName(v string) {
	o.PublicName = v
}
