...
type FilterDisplayData struct {
	CollectionFilterDisplayData   *CollectionFilterDisplayData
...
func (dst *FilterDisplayData) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into CollectionFilterDisplayData
	err = json.Unmarshal(data, &dst.CollectionFilterDisplayData)
	if err == nil {
		jsonCollectionFilterDisplayData, _ := json.Marshal(dst.CollectionFilterDisplayData)
		if string(jsonCollectionFilterDisplayData) == "{}" { // empty struct
			dst.CollectionFilterDisplayData = nil
		} else {
			return nil // data stored in dst.CollectionFilterDisplayData, return on the first match
		}
	} else {
		dst.CollectionFilterDisplayData = nil
	}
...
func (src FilterDisplayData) MarshalJSON() ([]byte, error) {
	if src.CollectionFilterDisplayData != nil {
		return json.Marshal(&src.CollectionFilterDisplayData)
	}
