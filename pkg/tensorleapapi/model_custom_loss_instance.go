...
type _CustomLossInstance CustomLossInstance
...
func (o *CustomLossInstance) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomLossInstance := _CustomLossInstance{}

	err = json.Unmarshal(data, &varCustomLossInstance)

	if err != nil {
		return err
	}

	*o = CustomLossInstance(varCustomLossInstance)
