...
type _StartTrialParams StartTrialParams
...
func (o *StartTrialParams) UnmarshalJSON(data []byte) (err error) {
	...
	varStartTrialParams := _StartTrialParams{}

	err = json.Unmarshal(data, &varStartTrialParams)

	if err != nil {
		return err
	}

	*o = StartTrialParams(varStartTrialParams)
