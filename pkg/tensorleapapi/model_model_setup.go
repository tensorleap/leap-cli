...
func (o *ModelSetup) UnmarshalJSON(data []byte) (err error) {
	...
	varModelSetup := _ModelSetup{}

	err = json.Unmarshal(data, &varModelSetup)

	if err != nil {
		return err
	}

	*o = ModelSetup(varModelSetup)
