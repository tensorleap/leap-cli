...
type _GeneralMessageParams GeneralMessageParams
...
func (o *GeneralMessageParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGeneralMessageParams := _GeneralMessageParams{}

	err = json.Unmarshal(data, &varGeneralMessageParams)

	if err != nil {
		return err
	}

	*o = GeneralMessageParams(varGeneralMessageParams)
