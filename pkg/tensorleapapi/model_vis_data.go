...
type VisData struct {
	...
	TextData          *TextData
	VideoData         *VideoData
	VideoHeatmapData  *VideoHeatmapData
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *VisData) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into AudioData
	err = json.Unmarshal(data, &dst.AudioData)
	if err == nil {
		jsonAudioData, _ := json.Marshal(dst.AudioData)
		if string(jsonAudioData) == "{}" { // empty struct
			dst.AudioData = nil
		} else {
			return nil // data stored in dst.AudioData, return on the first match
		}
	} else {
		dst.AudioData = nil
	}
	...
	// try to unmarshal JSON data into VideoHeatmapData
	err = json.Unmarshal(data, &dst.VideoHeatmapData)
	if err == nil {
		jsonVideoHeatmapData, _ := json.Marshal(dst.VideoHeatmapData)
		if string(jsonVideoHeatmapData) == "{}" { // empty struct
			dst.VideoHeatmapData = nil
		} else {
			return nil // data stored in dst.VideoHeatmapData, return on the first match
		}
	} else {
		dst.VideoHeatmapData = nil
	}
...
func (src VisData) MarshalJSON() ([]byte, error) {
	if src.AudioData != nil {
		return json.Marshal(&src.AudioData)
	}
	...
	if src.VideoHeatmapData != nil {
		return json.Marshal(&src.VideoHeatmapData)
	}
