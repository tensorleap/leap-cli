...
type _ExportProjectResponse ExportProjectResponse
...
func (o *ExportProjectResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExportProjectResponse := _ExportProjectResponse{}

	err = json.Unmarshal(data, &varExportProjectResponse)

	if err != nil {
		return err
	}

	*o = ExportProjectResponse(varExportProjectResponse)
