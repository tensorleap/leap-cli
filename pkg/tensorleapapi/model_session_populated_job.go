...
type _SessionPopulatedJob SessionPopulatedJob
...
func (o *SessionPopulatedJob) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionPopulatedJob := _SessionPopulatedJob{}

	err = json.Unmarshal(data, &varSessionPopulatedJob)

	if err != nil {
		return err
	}

	*o = SessionPopulatedJob(varSessionPopulatedJob)
