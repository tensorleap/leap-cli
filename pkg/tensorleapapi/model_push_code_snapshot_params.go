...
type PushCodeSnapshotParams struct {
	...
	EvaluateOnSuccess    *ChainedEvaluateRequest `json:"evaluateOnSuccess,omitempty"`
...
// GetEvaluateOnSuccess returns the EvaluateOnSuccess field value if set, zero value otherwise.
func (o *PushCodeSnapshotParams) GetEvaluateOnSuccess() ChainedEvaluateRequest {
	if o == nil || IsNil(o.EvaluateOnSuccess) {
		var ret ChainedEvaluateRequest
		return ret
	}
	return *o.EvaluateOnSuccess
}

// GetEvaluateOnSuccessOk returns a tuple with the EvaluateOnSuccess field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PushCodeSnapshotParams) GetEvaluateOnSuccessOk() (*ChainedEvaluateRequest, bool) {
	if o == nil || IsNil(o.EvaluateOnSuccess) {
		return nil, false
	}
	return o.EvaluateOnSuccess, true
}
...
// SetEvaluateOnSuccess gets a reference to the given ChainedEvaluateRequest and assigns it to the EvaluateOnSuccess field.
func (o *PushCodeSnapshotParams) SetEvaluateOnSuccess(v ChainedEvaluateRequest) {
	o.EvaluateOnSuccess = &v
}
...
func (o PushCodeSnapshotParams) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EvaluateOnSuccess) {
		toSerialize["evaluateOnSuccess"] = o.EvaluateOnSuccess
	}
...
func (o *PushCodeSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PushCodeSnapshotParams(varPushCodeSnapshotParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "evaluateOnSuccess")
