...
type TrainFromInitialWeightsParams struct {
	...
	FromSessionRunId string `json:"fromSessionRunId"`
...
func NewTrainFromInitialWeightsParams(versionId string, fromSessionRunId string, fromEpoch float64, modelName string, trainingParams TrainingParams, shouldRunPopulationExploration bool) *TrainFromInitialWeightsParams {
	...
	this.FromSessionRunId = fromSessionRunId
...
// GetFromSessionRunId returns the FromSessionRunId field value
func (o *TrainFromInitialWeightsParams) GetFromSessionRunId() string {
	...
	return o.FromSessionRunId
}

// GetFromSessionRunIdOk returns a tuple with the FromSessionRunId field value
// and a boolean to check if the value has been set.
func (o *TrainFromInitialWeightsParams) GetFromSessionRunIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FromSessionRunId, true
}

// SetFromSessionRunId sets field value
func (o *TrainFromInitialWeightsParams) SetFromSessionRunId(v string) {
	o.FromSessionRunId = v
}
...
func (o TrainFromInitialWeightsParams) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["fromSessionRunId"] = o.FromSessionRunId
