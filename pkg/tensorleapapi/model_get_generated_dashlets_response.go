...
type _GetGeneratedDashletsResponse GetGeneratedDashletsResponse
...
func (o *GetGeneratedDashletsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGeneratedDashletsResponse := _GetGeneratedDashletsResponse{}

	err = json.Unmarshal(data, &varGetGeneratedDashletsResponse)

	if err != nil {
		return err
	}

	*o = GetGeneratedDashletsResponse(varGetGeneratedDashletsResponse)
