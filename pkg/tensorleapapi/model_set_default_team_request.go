...
type _SetDefaultTeamRequest SetDefaultTeamRequest
...
func (o *SetDefaultTeamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetDefaultTeamRequest := _SetDefaultTeamRequest{}

	err = json.Unmarshal(data, &varSetDefaultTeamRequest)

	if err != nil {
		return err
	}

	*o = SetDefaultTeamRequest(varSetDefaultTeamRequest)
