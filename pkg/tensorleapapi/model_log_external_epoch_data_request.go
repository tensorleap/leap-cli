...
type _LogExternalEpochDataRequest LogExternalEpochDataRequest
...
func (o *LogExternalEpochDataRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLogExternalEpochDataRequest := _LogExternalEpochDataRequest{}

	err = json.Unmarshal(data, &varLogExternalEpochDataRequest)

	if err != nil {
		return err
	}

	*o = LogExternalEpochDataRequest(varLogExternalEpochDataRequest)
