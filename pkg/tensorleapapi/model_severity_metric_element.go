...
type _SeverityMetricElement SeverityMetricElement
...
func (o *SeverityMetricElement) UnmarshalJSON(data []byte) (err error) {
	...
	varSeverityMetricElement := _SeverityMetricElement{}

	err = json.Unmarshal(data, &varSeverityMetricElement)

	if err != nil {
		return err
	}

	*o = SeverityMetricElement(varSeverityMetricElement)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "normalized_value")
