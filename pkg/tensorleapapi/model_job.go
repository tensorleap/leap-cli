...
type Job struct {
	...
	SessionRun NullableString `json:"sessionRun"`
...
func (o *Job) GetSessionRun() string {
	if o == nil || o.SessionRun.Get() == nil {
		var ret string
		return ret
	}

	return *o.SessionRun.Get()
}
...
func (o *Job) GetSessionRunOk() (*string, bool) {
	...
	return o.SessionRun.Get(), o.SessionRun.IsSet()
}
...
func (o Job) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["sessionRun"] = o.SessionRun.Get()
