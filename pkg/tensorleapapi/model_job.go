...
type Job struct {
	...
	ChainedEvaluate      *ChainedEvaluateInfo `json:"chainedEvaluate,omitempty"`
...
// GetChainedEvaluate returns the ChainedEvaluate field value if set, zero value otherwise.
func (o *Job) GetChainedEvaluate() ChainedEvaluateInfo {
	if o == nil || IsNil(o.ChainedEvaluate) {
		var ret ChainedEvaluateInfo
		return ret
	}
	return *o.ChainedEvaluate
}

// GetChainedEvaluateOk returns a tuple with the ChainedEvaluate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Job) GetChainedEvaluateOk() (*ChainedEvaluateInfo, bool) {
	if o == nil || IsNil(o.ChainedEvaluate) {
		return nil, false
	}
	return o.ChainedEvaluate, true
}
...
// SetChainedEvaluate gets a reference to the given ChainedEvaluateInfo and assigns it to the ChainedEvaluate field.
...
func (o Job) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ChainedEvaluate) {
		toSerialize["chainedEvaluate"] = o.ChainedEvaluate
	}
...
func (o *Job) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Job(varJob)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "chainedEvaluate")
