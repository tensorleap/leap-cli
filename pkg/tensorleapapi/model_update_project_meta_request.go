...
type _UpdateProjectMetaRequest UpdateProjectMetaRequest
...
func (o *UpdateProjectMetaRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateProjectMetaRequest := _UpdateProjectMetaRequest{}

	err = json.Unmarshal(data, &varUpdateProjectMetaRequest)

	if err != nil {
		return err
	}

	*o = UpdateProjectMetaRequest(varUpdateProjectMetaRequest)
