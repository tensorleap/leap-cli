...
type _GetSampleCollectionsParams GetSampleCollectionsParams
...
func (o *GetSampleCollectionsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSampleCollectionsParams := _GetSampleCollectionsParams{}

	err = json.Unmarshal(data, &varGetSampleCollectionsParams)

	if err != nil {
		return err
	}

	*o = GetSampleCollectionsParams(varGetSampleCollectionsParams)
