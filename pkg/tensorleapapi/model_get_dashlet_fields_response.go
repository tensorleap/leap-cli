...
// GetBooleanFields returns the BooleanFields field value
func (o *GetDashletFieldsResponse) GetBooleanFields() []string {
	...
	return o.BooleanFields
}

// GetBooleanFieldsOk returns a tuple with the BooleanFields field value
// and a boolean to check if the value has been set.
func (o *GetDashletFieldsResponse) GetBooleanFieldsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.BooleanFields, true
}

// SetBooleanFields sets field value
...
func (o GetDashletFieldsResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["booleanFields"] = o.BooleanFields
...
func (o *GetDashletFieldsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GetDashletFieldsResponse(varGetDashletFieldsResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "booleanFields")
