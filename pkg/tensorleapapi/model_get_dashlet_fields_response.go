...
type GetDashletFieldsResponse struct {
	...
	NumericFieldsOptions []GetDashletFieldsResponseNumericFieldsOptionsInner `json:"numericFieldsOptions"`
}
...
func NewGetDashletFieldsResponse(aggregatableFields []string, numericFields []string, stringFields []string, numericFieldsOptions []GetDashletFieldsResponseNumericFieldsOptionsInner) *GetDashletFieldsResponse {
	...
	this.NumericFieldsOptions = numericFieldsOptions
	return &this
}
...
// GetNumericFieldsOptions returns the NumericFieldsOptions field value
func (o *GetDashletFieldsResponse) GetNumericFieldsOptions() []GetDashletFieldsResponseNumericFieldsOptionsInner {
	if o == nil {
		var ret []GetDashletFieldsResponseNumericFieldsOptionsInner
		return ret
	}

	return o.NumericFieldsOptions
}

// GetNumericFieldsOptionsOk returns a tuple with the NumericFieldsOptions field value
// and a boolean to check if the value has been set.
func (o *GetDashletFieldsResponse) GetNumericFieldsOptionsOk() ([]GetDashletFieldsResponseNumericFieldsOptionsInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.NumericFieldsOptions, true
}

// SetNumericFieldsOptions sets field value
func (o *GetDashletFieldsResponse) SetNumericFieldsOptions(v []GetDashletFieldsResponseNumericFieldsOptionsInner) {
	o.NumericFieldsOptions = v
}
...
func (o GetDashletFieldsResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["numericFieldsOptions"] = o.NumericFieldsOptions
