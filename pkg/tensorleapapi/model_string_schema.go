...
type _StringSchema StringSchema
...
func (o *StringSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varStringSchema := _StringSchema{}

	err = json.Unmarshal(data, &varStringSchema)

	if err != nil {
		return err
	}

	*o = StringSchema(varStringSchema)
