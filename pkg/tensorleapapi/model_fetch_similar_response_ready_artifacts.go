...
type _FetchSimilarResponseReadyArtifacts FetchSimilarResponseReadyArtifacts
...
func (o *FetchSimilarResponseReadyArtifacts) UnmarshalJSON(data []byte) (err error) {
	varFetchSimilarResponseReadyArtifacts := _FetchSimilarResponseReadyArtifacts{}

	err = json.Unmarshal(data, &varFetchSimilarResponseReadyArtifacts)

	if err != nil {
		return err
	}

	*o = FetchSimilarResponseReadyArtifacts(varFetchSimilarResponseReadyArtifacts)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "clusterPath")
