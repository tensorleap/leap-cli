...
type _MachineTypeOption MachineTypeOption
...
func (o *MachineTypeOption) UnmarshalJSON(data []byte) (err error) {
	...
	varMachineTypeOption := _MachineTypeOption{}

	err = json.Unmarshal(data, &varMachineTypeOption)

	if err != nil {
		return err
	}

	*o = MachineTypeOption(varMachineTypeOption)
