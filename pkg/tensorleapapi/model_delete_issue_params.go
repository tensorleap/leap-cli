...
type _DeleteIssueParams DeleteIssueParams
...
func (o *DeleteIssueParams) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteIssueParams := _DeleteIssueParams{}

	err = json.Unmarshal(data, &varDeleteIssueParams)

	if err != nil {
		return err
	}

	*o = DeleteIssueParams(varDeleteIssueParams)
