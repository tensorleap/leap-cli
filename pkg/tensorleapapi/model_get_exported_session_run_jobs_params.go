...
type _GetExportedSessionRunJobsParams GetExportedSessionRunJobsParams
...
func (o *GetExportedSessionRunJobsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetExportedSessionRunJobsParams := _GetExportedSessionRunJobsParams{}

	err = json.Unmarshal(data, &varGetExportedSessionRunJobsParams)

	if err != nil {
		return err
	}

	*o = GetExportedSessionRunJobsParams(varGetExportedSessionRunJobsParams)
