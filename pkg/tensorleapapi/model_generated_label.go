...
type GeneratedLabel struct {
	...
	SuggestedClusterFileUrl *string     `json:"suggestedClusterFileUrl,omitempty"`
...
// GetSuggestedClusterFileUrl returns the SuggestedClusterFileUrl field value if set, zero value otherwise.
func (o *GeneratedLabel) GetSuggestedClusterFileUrl() string {
	if o == nil || IsNil(o.SuggestedClusterFileUrl) {
		var ret string
		return ret
	}
	return *o.SuggestedClusterFileUrl
}

// GetSuggestedClusterFileUrlOk returns a tuple with the SuggestedClusterFileUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GeneratedLabel) GetSuggestedClusterFileUrlOk() (*string, bool) {
	if o == nil || IsNil(o.SuggestedClusterFileUrl) {
		return nil, false
	}
	return o.SuggestedClusterFileUrl, true
}
...
// SetSuggestedClusterFileUrl gets a reference to the given string and assigns it to the SuggestedClusterFileUrl field.
func (o *GeneratedLabel) SetSuggestedClusterFileUrl(v string) {
	o.SuggestedClusterFileUrl = &v
}
...
func (o GeneratedLabel) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SuggestedClusterFileUrl) {
		toSerialize["suggestedClusterFileUrl"] = o.SuggestedClusterFileUrl
	}
...
func (o *GeneratedLabel) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GeneratedLabel(varGeneratedLabel)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "suggestedClusterFileUrl")
