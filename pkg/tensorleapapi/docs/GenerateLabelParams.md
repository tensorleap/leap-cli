...
**LatentSpaceType** | Pointer to **string** | Latent space friendly name, e.g. &#39;balanced&#39;. Engine falls back to default when unset. | [optional] 
...
`func (o *GenerateLabelParams) GetLatentSpaceType() string`

GetLatentSpaceType returns the LatentSpaceType field if non-nil, zero value otherwise.

### GetLatentSpaceTypeOk

`func (o *GenerateLabelParams) GetLatentSpaceTypeOk() (*string, bool)`
...
`func (o *GenerateLabelParams) SetLatentSpaceType(v string)`

SetLatentSpaceType sets LatentSpaceType field to given value.

### HasLatentSpaceType

`func (o *GenerateLabelParams) HasLatentSpaceType() bool`
