...
`func (o *DomainGapInsight) GetAutomaticTests() []InsightAutomaticTest`

GetAutomaticTests returns the AutomaticTests field if non-nil, zero value otherwise.

### GetAutomaticTestsOk

`func (o *DomainGapInsight) GetAutomaticTestsOk() (*[]InsightAutomaticTest, bool)`
...
`func (o *DomainGapInsight) SetAutomaticTests(v []InsightAutomaticTest)`

SetAutomaticTests sets AutomaticTests field to given value.

### HasAutomaticTests

`func (o *DomainGapInsight) HasAutomaticTests() bool`
