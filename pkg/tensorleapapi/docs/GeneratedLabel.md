...
`func (o *GeneratedLabel) SetLatentSpaceType(v string)`

SetLatentSpaceType sets LatentSpaceType field to given value.

### HasLatentSpaceType

`func (o *GeneratedLabel) HasLatentSpaceType() bool`
