...
`func NewJobNotificationContext(jobId string, jobType JobType, codeSnapshotId string, projectName string, projectId string, modelName string, modelExtId string, isOverwrite bool, versionId string, sessionRunId string, sample SampleIdentity, ) *JobNotificationContext`
