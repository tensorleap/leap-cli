...
`func (o *JobNotificationSampleContext) GetJobSubType() JobSubType`

GetJobSubType returns the JobSubType field if non-nil, zero value otherwise.

### GetJobSubTypeOk

`func (o *JobNotificationSampleContext) GetJobSubTypeOk() (*JobSubType, bool)`
...
`func (o *JobNotificationSampleContext) SetJobSubType(v JobSubType)`

SetJobSubType sets JobSubType field to given value.

### HasJobSubType

`func (o *JobNotificationSampleContext) HasJobSubType() bool`
