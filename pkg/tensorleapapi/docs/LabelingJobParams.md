...
`func NewLabelingJobParams(digest string, labelingAlgorithm LabelingAlgorithm, numOfSamplesToLabel float64, fromEpoch float64, sessionRunId string, type_ string, ) *LabelingJobParams`
