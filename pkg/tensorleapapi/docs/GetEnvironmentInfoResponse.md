...
**LocalBucketPath** | Pointer to **string** |  | [optional] 
...
`func (o *GetEnvironmentInfoResponse) GetLocalBucketPath() string`

GetLocalBucketPath returns the LocalBucketPath field if non-nil, zero value otherwise.

### GetLocalBucketPathOk

`func (o *GetEnvironmentInfoResponse) GetLocalBucketPathOk() (*string, bool)`

GetLocalBucketPathOk returns a tuple with the LocalBucketPath field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetLocalBucketPath

`func (o *GetEnvironmentInfoResponse) SetLocalBucketPath(v string)`

SetLocalBucketPath sets LocalBucketPath field to given value.

### HasLocalBucketPath

`func (o *GetEnvironmentInfoResponse) HasLocalBucketPath() bool`

HasLocalBucketPath returns a boolean if a field has been set.
