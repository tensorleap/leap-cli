...
type _AddSecretManagerParams AddSecretManagerParams
...
func (o *AddSecretManagerParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAddSecretManagerParams := _AddSecretManagerParams{}

	err = json.Unmarshal(data, &varAddSecretManagerParams)

	if err != nil {
		return err
	}

	*o = AddSecretManagerParams(varAddSecretManagerParams)
