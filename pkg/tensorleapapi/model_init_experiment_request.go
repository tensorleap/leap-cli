...
type _InitExperimentRequest InitExperimentRequest
...
func (o *InitExperimentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varInitExperimentRequest := _InitExperimentRequest{}

	err = json.Unmarshal(data, &varInitExperimentRequest)

	if err != nil {
		return err
	}

	*o = InitExperimentRequest(varInitExperimentRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "codeIntegrationName")
		delete(additionalProperties, "experimentName")
		delete(additionalProperties, "removeUntaggedUploadedModels")
