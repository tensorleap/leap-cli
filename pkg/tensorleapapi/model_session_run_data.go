...
func (o *SessionRunData) GetEvaluateParams() SessionRunEvaluateParams {
	if o == nil || IsNil(o.EvaluateParams) {
		var ret SessionRunEvaluateParams
		return ret
	}
...
// SetEvaluateParams gets a reference to the given SessionRunEvaluateParams and assigns it to the EvaluateParams field.
...
func (o *SessionRunData) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionRunData := _SessionRunData{}

	err = json.Unmarshal(data, &varSessionRunData)

	if err != nil {
		return err
	}

	*o = SessionRunData(varSessionRunData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "weightAssets")
