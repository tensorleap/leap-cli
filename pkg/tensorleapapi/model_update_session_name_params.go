...
type _UpdateSessionNameParams UpdateSessionNameParams
...
func (o *UpdateSessionNameParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateSessionNameParams := _UpdateSessionNameParams{}

	err = json.Unmarshal(data, &varUpdateSessionNameParams)

	if err != nil {
		return err
	}

	*o = UpdateSessionNameParams(varUpdateSessionNameParams)
