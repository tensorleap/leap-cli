...
type _GetScatterSampleVisualizationsParams GetScatterSampleVisualizationsParams
...
func (o *GetScatterSampleVisualizationsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetScatterSampleVisualizationsParams := _GetScatterSampleVisualizationsParams{}

	err = json.Unmarshal(data, &varGetScatterSampleVisualizationsParams)

	if err != nil {
		return err
	}

	*o = GetScatterSampleVisualizationsParams(varGetScatterSampleVisualizationsParams)
