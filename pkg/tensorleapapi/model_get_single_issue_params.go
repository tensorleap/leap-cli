...
type _GetSingleIssueParams GetSingleIssueParams
...
func (o *GetSingleIssueParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetSingleIssueParams := _GetSingleIssueParams{}

	err = json.Unmarshal(data, &varGetSingleIssueParams)

	if err != nil {
		return err
	}

	*o = GetSingleIssueParams(varGetSingleIssueParams)
