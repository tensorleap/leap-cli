...
type _AddSecretManagerResponse AddSecretManagerResponse
...
func (o *AddSecretManagerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAddSecretManagerResponse := _AddSecretManagerResponse{}

	err = json.Unmarshal(data, &varAddSecretManagerResponse)

	if err != nil {
		return err
	}

	*o = AddSecretManagerResponse(varAddSecretManagerResponse)
