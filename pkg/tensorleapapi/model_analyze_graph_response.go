...
type _AnalyzeGraphResponse AnalyzeGraphResponse
...
func (o *AnalyzeGraphResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAnalyzeGraphResponse := _AnalyzeGraphResponse{}

	err = json.Unmarshal(data, &varAnalyzeGraphResponse)

	if err != nil {
		return err
	}

	*o = AnalyzeGraphResponse(varAnalyzeGraphResponse)
