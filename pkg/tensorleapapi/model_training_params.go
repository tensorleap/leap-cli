...
type _TrainingParams TrainingParams
...
func (o *TrainingParams) UnmarshalJSON(data []byte) (err error) {
	...
	varTrainingParams := _TrainingParams{}

	err = json.Unmarshal(data, &varTrainingParams)

	if err != nil {
		return err
	}

	*o = TrainingParams(varTrainingParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "early_stop_params")
