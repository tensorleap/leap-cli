...
type _AddIssueParams AddIssueParams
...
func (o *AddIssueParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAddIssueParams := _AddIssueParams{}

	err = json.Unmarshal(data, &varAddIssueParams)

	if err != nil {
		return err
	}

	*o = AddIssueParams(varAddIssueParams)
