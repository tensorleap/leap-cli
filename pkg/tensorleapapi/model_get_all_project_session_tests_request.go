...
type _GetAllProjectSessionTestsRequest GetAllProjectSessionTestsRequest
...
func (o *GetAllProjectSessionTestsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllProjectSessionTestsRequest := _GetAllProjectSessionTestsRequest{}

	err = json.Unmarshal(data, &varGetAllProjectSessionTestsRequest)

	if err != nil {
		return err
	}

	*o = GetAllProjectSessionTestsRequest(varGetAllProjectSessionTestsRequest)
