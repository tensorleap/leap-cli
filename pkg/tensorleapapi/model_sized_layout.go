...
func (o *SizedLayout) UnmarshalJSON(data []byte) (err error) {
	...
	varSizedLayout := _SizedLayout{}

	err = json.Unmarshal(data, &varSizedLayout)

	if err != nil {
		return err
	}

	*o = SizedLayout(varSizedLayout)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "xs")
		delete(additionalProperties, "sm")
		delete(additionalProperties, "md")
		delete(additionalProperties, "lg")
