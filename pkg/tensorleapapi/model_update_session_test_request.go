...
type _UpdateSessionTestRequest UpdateSessionTestRequest
...
func (o *UpdateSessionTestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateSessionTestRequest := _UpdateSessionTestRequest{}

	err = json.Unmarshal(data, &varUpdateSessionTestRequest)

	if err != nil {
		return err
	}

	*o = UpdateSessionTestRequest(varUpdateSessionTestRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "testFilter")
		delete(additionalProperties, "datasetFilter")
