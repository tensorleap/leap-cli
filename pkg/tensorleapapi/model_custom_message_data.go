...
type _CustomMessageData CustomMessageData
...
func (o *CustomMessageData) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomMessageData := _CustomMessageData{}

	err = json.Unmarshal(data, &varCustomMessageData)

	if err != nil {
		return err
	}

	*o = CustomMessageData(varCustomMessageData)
