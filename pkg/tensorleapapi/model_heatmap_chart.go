...
type _HeatmapChart HeatmapChart
...
func (o *HeatmapChart) UnmarshalJSON(data []byte) (err error) {
	...
	varHeatmapChart := _HeatmapChart{}

	err = json.Unmarshal(data, &varHeatmapChart)

	if err != nil {
		return err
	}

	*o = HeatmapChart(varHeatmapChart)
