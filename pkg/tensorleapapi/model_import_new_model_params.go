...
type _ImportNewModelParams ImportNewModelParams
...
func (o *ImportNewModelParams) UnmarshalJSON(data []byte) (err error) {
	...
	varImportNewModelParams := _ImportNewModelParams{}

	err = json.Unmarshal(data, &varImportNewModelParams)

	if err != nil {
		return err
	}

	*o = ImportNewModelParams(varImportNewModelParams)
