...
type ImportNewModelParams struct {
	...
	MappingYaml           *string         `json:"mappingYaml,omitempty"`
}
...
// GetMappingYaml returns the MappingYaml field value if set, zero value otherwise.
func (o *ImportNewModelParams) GetMappingYaml() string {
	if o == nil || IsNil(o.MappingYaml) {
		var ret string
		return ret
	}
	return *o.MappingYaml
}

// GetMappingYamlOk returns a tuple with the MappingYaml field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImportNewModelParams) GetMappingYamlOk() (*string, bool) {
	if o == nil || IsNil(o.MappingYaml) {
		return nil, false
	}
	return o.MappingYaml, true
}
...
// SetMappingYaml gets a reference to the given string and assigns it to the MappingYaml field.
...
func (o ImportNewModelParams) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MappingYaml) {
		toSerialize["mappingYaml"] = o.MappingYaml
	}
