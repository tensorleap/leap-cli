...
type _DatasetMessageParams DatasetMessageParams
...
func (o *DatasetMessageParams) UnmarshalJSON(data []byte) (err error) {
	...
	varDatasetMessageParams := _DatasetMessageParams{}

	err = json.Unmarshal(data, &varDatasetMessageParams)

	if err != nil {
		return err
	}

	*o = DatasetMessageParams(varDatasetMessageParams)
