...
type _GenericDataItem GenericDataItem
...
func (o *GenericDataItem) UnmarshalJSON(data []byte) (err error) {
	...
	varGenericDataItem := _GenericDataItem{}

	err = json.Unmarshal(data, &varGenericDataItem)

	if err != nil {
		return err
	}

	*o = GenericDataItem(varGenericDataItem)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "innerKey")
