...
type _DatasetSetup DatasetSetup
...
func (o *DatasetSetup) UnmarshalJSON(data []byte) (err error) {
	...
	varDatasetSetup := _DatasetSetup{}

	err = json.Unmarshal(data, &varDatasetSetup)

	if err != nil {
		return err
	}

	*o = DatasetSetup(varDatasetSetup)
