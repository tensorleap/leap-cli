...
type _AddDashboardParams AddDashboardParams
...
func (o *AddDashboardParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAddDashboardParams := _AddDashboardParams{}

	err = json.Unmarshal(data, &varAddDashboardParams)

	if err != nil {
		return err
	}

	*o = AddDashboardParams(varAddDashboardParams)
