...
type _AddSampleCollectionResponse AddSampleCollectionResponse
...
func (o *AddSampleCollectionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAddSampleCollectionResponse := _AddSampleCollectionResponse{}

	err = json.Unmarshal(data, &varAddSampleCollectionResponse)

	if err != nil {
		return err
	}

	*o = AddSampleCollectionResponse(varAddSampleCollectionResponse)
