...
func (o *GraphViz) UnmarshalJSON(data []byte) (err error) {
	...
	varGraphViz := _GraphViz{}

	err = json.Unmarshal(data, &varGraphViz)

	if err != nil {
		return err
	}

	*o = GraphViz(varGraphViz)
