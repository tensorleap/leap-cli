...
type _UserDataMetadata UserDataMetadata
...
func (o *UserDataMetadata) UnmarshalJSON(data []byte) (err error) {
	varUserDataMetadata := _UserDataMetadata{}

	err = json.Unmarshal(data, &varUserDataMetadata)

	if err != nil {
		return err
	}

	*o = UserDataMetadata(varUserDataMetadata)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "dnnLevel")
		delete(additionalProperties, "company")
		delete(additionalProperties, "title")
		delete(additionalProperties, "companySize")
