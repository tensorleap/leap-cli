...
type AnalyzeParams struct {
	...
	DomainGapId          *string         `json:"domainGapId,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AnalyzeParams AnalyzeParams
...
// GetDomainGapId returns the DomainGapId field value if set, zero value otherwise.
func (o *AnalyzeParams) GetDomainGapId() string {
	if o == nil || IsNil(o.DomainGapId) {
		var ret string
		return ret
	}
...
// GetDomainGapIdOk returns a tuple with the DomainGapId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDomainGapId gets a reference to the given string and assigns it to the DomainGapId field.
...
func (o *AnalyzeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAnalyzeParams := _AnalyzeParams{}

	err = json.Unmarshal(data, &varAnalyzeParams)

	if err != nil {
		return err
	}

	*o = AnalyzeParams(varAnalyzeParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "fromDatasetSlice")
