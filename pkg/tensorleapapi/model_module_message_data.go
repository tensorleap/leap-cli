...
type ModuleMessageData struct {
	CodeMessageParams       *CodeMessageParams
...
func (dst *ModuleMessageData) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into CodeMessageParams
	err = json.Unmarshal(data, &dst.CodeMessageParams)
	if err == nil {
		jsonCodeMessageParams, _ := json.Marshal(dst.CodeMessageParams)
		if string(jsonCodeMessageParams) == "{}" { // empty struct
			dst.CodeMessageParams = nil
		} else {
			return nil // data stored in dst.CodeMessageParams, return on the first match
		}
	} else {
		dst.CodeMessageParams = nil
	}
...
func (src ModuleMessageData) MarshalJSON() ([]byte, error) {
	if src.CodeMessageParams != nil {
		return json.Marshal(&src.CodeMessageParams)
	}
