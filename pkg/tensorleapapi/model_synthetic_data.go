...
type SyntheticData struct {
	...
	SuggestionsFileUrl   *string                                   `json:"suggestionsFileUrl,omitempty"`
...
// GetSuggestionsFileUrl returns the SuggestionsFileUrl field value if set, zero value otherwise.
func (o *SyntheticData) GetSuggestionsFileUrl() string {
	if o == nil || IsNil(o.SuggestionsFileUrl) {
		var ret string
		return ret
	}
	return *o.SuggestionsFileUrl
}

// GetSuggestionsFileUrlOk returns a tuple with the SuggestionsFileUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SyntheticData) GetSuggestionsFileUrlOk() (*string, bool) {
	if o == nil || IsNil(o.SuggestionsFileUrl) {
		return nil, false
	}
	return o.SuggestionsFileUrl, true
}
...
// SetSuggestionsFileUrl gets a reference to the given string and assigns it to the SuggestionsFileUrl field.
func (o *SyntheticData) SetSuggestionsFileUrl(v string) {
	o.SuggestionsFileUrl = &v
}
...
func (o SyntheticData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SuggestionsFileUrl) {
		toSerialize["suggestionsFileUrl"] = o.SuggestionsFileUrl
	}
...
func (o *SyntheticData) UnmarshalJSON(data []byte) (err error) {
	...
	*o = SyntheticData(varSyntheticData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "suggestionsFileUrl")
