...
func (o *SlimTeam) UnmarshalJSON(data []byte) (err error) {
	...
	varSlimTeam := _SlimTeam{}

	err = json.Unmarshal(data, &varSlimTeam)

	if err != nil {
		return err
	}

	*o = SlimTeam(varSlimTeam)
