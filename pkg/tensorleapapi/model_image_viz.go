...
func (o *ImageViz) UnmarshalJSON(data []byte) (err error) {
	...
	varImageViz := _ImageViz{}

	err = json.Unmarshal(data, &varImageViz)

	if err != nil {
		return err
	}

	*o = ImageViz(varImageViz)
