...
func (o *JobEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varJobEvent := _JobEvent{}

	err = json.Unmarshal(data, &varJobEvent)

	if err != nil {
		return err
	}

	*o = JobEvent(varJobEvent)
