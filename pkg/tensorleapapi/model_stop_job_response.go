...
type _StopJobResponse StopJobResponse
...
func (o *StopJobResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStopJobResponse := _StopJobResponse{}

	err = json.Unmarshal(data, &varStopJobResponse)

	if err != nil {
		return err
	}

	*o = StopJobResponse(varStopJobResponse)
