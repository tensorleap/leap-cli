...
type _DeleteSessionParams DeleteSessionParams
...
func (o *DeleteSessionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteSessionParams := _DeleteSessionParams{}
	...
	*o = DeleteSessionParams(varDeleteSessionParams)
