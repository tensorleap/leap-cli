...
type _LossMessageParams LossMessageParams
...
func (o *LossMessageParams) UnmarshalJSON(data []byte) (err error) {
	...
	varLossMessageParams := _LossMessageParams{}

	err = json.Unmarshal(data, &varLossMessageParams)

	if err != nil {
		return err
	}

	*o = LossMessageParams(varLossMessageParams)
