...
type CodeSetup struct {
	...
	HasElementInstances  bool                     `json:"has_element_instances"`
...
func NewCodeSetup(preprocess CodePreprocess, inputs []CodeInputInstance, metadata []CodeMetadataInstance, outputs []CodeOutputInstance, visualizers []VisualizerInstance, predictionTypes []PredictionTypeInstance, customLosses []CustomLossInstance, metrics []MetricInstance, simulations []SimulationInstance, hasElementInstances bool) *CodeSetup {
	...
	this.HasElementInstances = hasElementInstances
	return &this
}
...
// GetHasElementInstances returns the HasElementInstances field value
func (o *CodeSetup) GetHasElementInstances() bool {
	...
	return o.HasElementInstances
}

// GetHasElementInstancesOk returns a tuple with the HasElementInstances field value
// and a boolean to check if the value has been set.
func (o *CodeSetup) GetHasElementInstancesOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HasElementInstances, true
}

// SetHasElementInstances sets field value
func (o *CodeSetup) SetHasElementInstances(v bool) {
	o.HasElementInstances = v
}
...
func (o CodeSetup) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["has_element_instances"] = o.HasElementInstances
...
func (o *CodeSetup) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CodeSetup(varCodeSetup)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "has_element_instances")
