...
type _GetValidateGraphProcessStateParams GetValidateGraphProcessStateParams
...
func (o *GetValidateGraphProcessStateParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetValidateGraphProcessStateParams := _GetValidateGraphProcessStateParams{}

	err = json.Unmarshal(data, &varGetValidateGraphProcessStateParams)

	if err != nil {
		return err
	}

	*o = GetValidateGraphProcessStateParams(varGetValidateGraphProcessStateParams)
