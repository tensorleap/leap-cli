...
type _GraphAnalyzerData GraphAnalyzerData
...
func (o *GraphAnalyzerData) UnmarshalJSON(data []byte) (err error) {
	...
	varGraphAnalyzerData := _GraphAnalyzerData{}

	err = json.Unmarshal(data, &varGraphAnalyzerData)

	if err != nil {
		return err
	}

	*o = GraphAnalyzerData(varGraphAnalyzerData)
