...
type _UserDataLocal UserDataLocal
...
func (o *UserDataLocal) UnmarshalJSON(data []byte) (err error) {
	...
	varUserDataLocal := _UserDataLocal{}

	err = json.Unmarshal(data, &varUserDataLocal)

	if err != nil {
		return err
	}

	*o = UserDataLocal(varUserDataLocal)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "trialRequested")
