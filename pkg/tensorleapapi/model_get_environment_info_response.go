...
type GetEnvironmentInfoResponse struct {
	...
	LocalBucketPath        *string          `json:"localBucketPath,omitempty"`
...
// GetLocalBucketPath returns the LocalBucketPath field value if set, zero value otherwise.
func (o *GetEnvironmentInfoResponse) GetLocalBucketPath() string {
	if o == nil || IsNil(o.LocalBucketPath) {
		var ret string
		return ret
	}
	return *o.LocalBucketPath
}

// GetLocalBucketPathOk returns a tuple with the LocalBucketPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetEnvironmentInfoResponse) GetLocalBucketPathOk() (*string, bool) {
	if o == nil || IsNil(o.LocalBucketPath) {
		return nil, false
	}
	return o.LocalBucketPath, true
}
...
// SetLocalBucketPath gets a reference to the given string and assigns it to the LocalBucketPath field.
...
func (o GetEnvironmentInfoResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LocalBucketPath) {
		toSerialize["localBucketPath"] = o.LocalBucketPath
	}
...
func (o *GetEnvironmentInfoResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GetEnvironmentInfoResponse(varGetEnvironmentInfoResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "localBucketPath")
