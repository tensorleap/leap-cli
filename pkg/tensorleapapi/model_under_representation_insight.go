...
func (o *UnderRepresentationInsight) GetLatentSpace() string {
...
// and a boolean to check if the value has been set.
func (o *UnderRepresentationInsight) GetLatentSpaceOk() (*string, bool) {
	if o == nil || IsNil(o.LatentSpace) {
		return nil, false
	}
...
func (o *UnderRepresentationInsight) HasLatentSpace() bool {
	if o != nil && !IsNil(o.LatentSpace) {
		return true
	}
...
func (o *UnderRepresentationInsight) SetLatentSpace(v string) {
	o.LatentSpace = &v
}
