...
type PopulationExplorationResponse struct {
	Status               PopulationExplorationResponseStatus   `json:"status"`
	JobId                *string                               `json:"jobId,omitempty"`
	ReadyArtifacts       PartialPopulationExplorationArtifacts `json:"readyArtifacts"`
	AdditionalProperties map[string]interface{}
}

type _PopulationExplorationResponse PopulationExplorationResponse
...
func (o *PopulationExplorationResponse) GetStatus() PopulationExplorationResponseStatus {
	if o == nil {
		var ret PopulationExplorationResponseStatus
		return ret
	}
...
func (o *PopulationExplorationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPopulationExplorationResponse := _PopulationExplorationResponse{}

	err = json.Unmarshal(data, &varPopulationExplorationResponse)

	if err != nil {
		return err
	}

	*o = PopulationExplorationResponse(varPopulationExplorationResponse)
