...
type _CreateSessionTestRequest CreateSessionTestRequest
...
func (o *CreateSessionTestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSessionTestRequest := _CreateSessionTestRequest{}

	err = json.Unmarshal(data, &varCreateSessionTestRequest)

	if err != nil {
		return err
	}

	*o = CreateSessionTestRequest(varCreateSessionTestRequest)
