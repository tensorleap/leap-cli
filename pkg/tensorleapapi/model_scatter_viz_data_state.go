...
type ScatterVizDataState struct {
	...
	// Construct a type with a set of properties K of type T
	DomainGapDist         map[string]interface{} `json:"domain_gap_dist,omitempty"`
	HiddenMetadataKeys    []string               `json:"hidden_metadata_keys,omitempty"`
	AvailableLatentSpaces []string               `json:"available_latent_spaces,omitempty"`
	AdditionalProperties  map[string]interface{}
}

type _ScatterVizDataState ScatterVizDataState
...
// GetDomainGapDist returns the DomainGapDist field value if set, zero value otherwise.
func (o *ScatterVizDataState) GetDomainGapDist() map[string]interface{} {
	if o == nil || IsNil(o.DomainGapDist) {
		var ret map[string]interface{}
		return ret
	}
	return o.DomainGapDist
}

// GetDomainGapDistOk returns a tuple with the DomainGapDist field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScatterVizDataState) GetDomainGapDistOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.DomainGapDist) {
		return map[string]interface{}{}, false
	}
	return o.DomainGapDist, true
}
...
// SetDomainGapDist gets a reference to the given map[string]interface{} and assigns it to the DomainGapDist field.
func (o *ScatterVizDataState) SetDomainGapDist(v map[string]interface{}) {
	o.DomainGapDist = v
}

// GetHiddenMetadataKeys returns the HiddenMetadataKeys field value if set, zero value otherwise.
func (o *ScatterVizDataState) GetHiddenMetadataKeys() []string {
	if o == nil || IsNil(o.HiddenMetadataKeys) {
		var ret []string
		return ret
	}
	return o.HiddenMetadataKeys
}

// GetHiddenMetadataKeysOk returns a tuple with the HiddenMetadataKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScatterVizDataState) GetHiddenMetadataKeysOk() ([]string, bool) {
	if o == nil || IsNil(o.HiddenMetadataKeys) {
		return nil, false
	}
	return o.HiddenMetadataKeys, true
}
...
// SetHiddenMetadataKeys gets a reference to the given []string and assigns it to the HiddenMetadataKeys field.
func (o *ScatterVizDataState) SetHiddenMetadataKeys(v []string) {
	o.HiddenMetadataKeys = v
}

// GetAvailableLatentSpaces returns the AvailableLatentSpaces field value if set, zero value otherwise.
func (o *ScatterVizDataState) GetAvailableLatentSpaces() []string {
	if o == nil || IsNil(o.AvailableLatentSpaces) {
		var ret []string
		return ret
	}
	return o.AvailableLatentSpaces
}

// GetAvailableLatentSpacesOk returns a tuple with the AvailableLatentSpaces field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScatterVizDataState) GetAvailableLatentSpacesOk() ([]string, bool) {
	if o == nil || IsNil(o.AvailableLatentSpaces) {
		return nil, false
	}
	return o.AvailableLatentSpaces, true
}
...
// SetAvailableLatentSpaces gets a reference to the given []string and assigns it to the AvailableLatentSpaces field.
func (o *ScatterVizDataState) SetAvailableLatentSpaces(v []string) {
	o.AvailableLatentSpaces = v
}
...
func (o ScatterVizDataState) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DomainGapDist) {
		toSerialize["domain_gap_dist"] = o.DomainGapDist
	}
	if !IsNil(o.HiddenMetadataKeys) {
		toSerialize["hidden_metadata_keys"] = o.HiddenMetadataKeys
	}
	if !IsNil(o.AvailableLatentSpaces) {
		toSerialize["available_latent_spaces"] = o.AvailableLatentSpaces
	}
...
func (o *ScatterVizDataState) UnmarshalJSON(data []byte) (err error) {
	...
	varScatterVizDataState := _ScatterVizDataState{}

	err = json.Unmarshal(data, &varScatterVizDataState)

	if err != nil {
		return err
	}

	*o = ScatterVizDataState(varScatterVizDataState)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "data_state")
		delete(additionalProperties, "scatter_data")
		delete(additionalProperties, "samples")
		delete(additionalProperties, "metadata")
		delete(additionalProperties, "mi_by_cluster")
		delete(additionalProperties, "clusters_blob_path")
		delete(additionalProperties, "domain_gap_dist")
		delete(additionalProperties, "hidden_metadata_keys")
		delete(additionalProperties, "available_latent_spaces")
