...
func (o *RunProcess) UnmarshalJSON(data []byte) (err error) {
	...
	varRunProcess := _RunProcess{}

	err = json.Unmarshal(data, &varRunProcess)

	if err != nil {
		return err
	}

	*o = RunProcess(varRunProcess)
