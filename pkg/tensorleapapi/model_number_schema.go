...
type _NumberSchema NumberSchema
...
// SetLimitedBy gets a reference to the given string and assigns it to the LimitedBy field.
...
func (o NumberSchema) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LimitedBy) {
		toSerialize["limitedBy"] = o.LimitedBy
	}
...
func (o *NumberSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varNumberSchema := _NumberSchema{}

	err = json.Unmarshal(data, &varNumberSchema)

	if err != nil {
		return err
	}

	*o = NumberSchema(varNumberSchema)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "limitedBy")
