...
type CustomLayerInstance struct {
	...
	UseCustomLatentSpace bool     `json:"use_custom_latent_space"`
}
...
func NewCustomLayerInstance(name string, initArgNames []string, callArgNames []string, useCustomLatentSpace bool) *CustomLayerInstance {
	...
	this.UseCustomLatentSpace = useCustomLatentSpace
	return &this
}
...
// GetUseCustomLatentSpace returns the UseCustomLatentSpace field value
...
// GetUseCustomLatentSpaceOk returns a tuple with the UseCustomLatentSpace field value
// and a boolean to check if the value has been set.
...
// SetUseCustomLatentSpace sets field value
