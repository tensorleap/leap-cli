...
type _GetDashletFieldsParams GetDashletFieldsParams
...
func (o *GetDashletFieldsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDashletFieldsParams := _GetDashletFieldsParams{}

	err = json.Unmarshal(data, &varGetDashletFieldsParams)

	if err != nil {
		return err
	}

	*o = GetDashletFieldsParams(varGetDashletFieldsParams)
