...
type _LocalLoginResponse LocalLoginResponse
...
func (o *LocalLoginResponse) UnmarshalJSON(data []byte) (err error) {
	varLocalLoginResponse := _LocalLoginResponse{}

	err = json.Unmarshal(data, &varLocalLoginResponse)

	if err != nil {
		return err
	}

	*o = LocalLoginResponse(varLocalLoginResponse)
