...
type _GetGeneratedDashletsParams GetGeneratedDashletsParams
...
func (o *GetGeneratedDashletsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGeneratedDashletsParams := _GetGeneratedDashletsParams{}

	err = json.Unmarshal(data, &varGetGeneratedDashletsParams)

	if err != nil {
		return err
	}

	*o = GetGeneratedDashletsParams(varGetGeneratedDashletsParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "resetPrevious")
