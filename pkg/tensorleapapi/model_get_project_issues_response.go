...
type _GetProjectIssuesResponse GetProjectIssuesResponse
...
func (o *GetProjectIssuesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetProjectIssuesResponse := _GetProjectIssuesResponse{}

	err = json.Unmarshal(data, &varGetProjectIssuesResponse)

	if err != nil {
		return err
	}

	*o = GetProjectIssuesResponse(varGetProjectIssuesResponse)
