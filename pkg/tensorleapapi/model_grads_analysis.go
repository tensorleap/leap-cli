...
type GradsAnalysis struct {
	...
	Algo                 *SampleAnalysisAlgo `json:"algo,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GradsAnalysis GradsAnalysis
...
// SetAlgo gets a reference to the given SampleAnalysisAlgo and assigns it to the Algo field.
...
func (o *GradsAnalysis) UnmarshalJSON(data []byte) (err error) {
	...
	varGradsAnalysis := _GradsAnalysis{}

	err = json.Unmarshal(data, &varGradsAnalysis)

	if err != nil {
		return err
	}

	*o = GradsAnalysis(varGradsAnalysis)
