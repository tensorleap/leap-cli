...
type _JobEventProgress JobEventProgress
...
func (o *JobEventProgress) UnmarshalJSON(data []byte) (err error) {
	...
	varJobEventProgress := _JobEventProgress{}

	err = json.Unmarshal(data, &varJobEventProgress)

	if err != nil {
		return err
	}

	*o = JobEventProgress(varJobEventProgress)
