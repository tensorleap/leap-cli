...
func (o *ScatterInsightBase) GetLatentSpace() string {
...
// and a boolean to check if the value has been set.
func (o *ScatterInsightBase) GetLatentSpaceOk() (*string, bool) {
	if o == nil || IsNil(o.LatentSpace) {
		return nil, false
	}
...
func (o *ScatterInsightBase) HasLatentSpace() bool {
	if o != nil && !IsNil(o.LatentSpace) {
		return true
	}
...
func (o *ScatterInsightBase) SetLatentSpace(v string) {
	o.LatentSpace = &v
}

// GetContainerLabel returns the ContainerLabel field value if set, zero value otherwise.
func (o *ScatterInsightBase) GetContainerLabel() string {
...
// and a boolean to check if the value has been set.
func (o *ScatterInsightBase) GetContainerLabelOk() (*string, bool) {
	if o == nil || IsNil(o.ContainerLabel) {
		return nil, false
	}
...
func (o *ScatterInsightBase) HasContainerLabel() bool {
	if o != nil && !IsNil(o.ContainerLabel) {
		return true
	}
...
func (o *ScatterInsightBase) SetContainerLabel(v string) {
	o.ContainerLabel = &v
}
