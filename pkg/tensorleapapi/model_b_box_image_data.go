...
type _BBoxImageData BBoxImageData
...
func (o *BBoxImageData) UnmarshalJSON(data []byte) (err error) {
	...
	varBBoxImageData := _BBoxImageData{}

	err = json.Unmarshal(data, &varBBoxImageData)

	if err != nil {
		return err
	}

	*o = BBoxImageData(varBBoxImageData)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "blob")
		delete(additionalProperties, "bounding_box")
