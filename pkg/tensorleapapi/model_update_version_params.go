...
type _UpdateVersionParams UpdateVersionParams
...
func (o *UpdateVersionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateVersionParams := _UpdateVersionParams{}

	err = json.Unmarshal(data, &varUpdateVersionParams)

	if err != nil {
		return err
	}

	*o = UpdateVersionParams(varUpdateVersionParams)
