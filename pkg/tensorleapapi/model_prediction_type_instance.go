...
type PredictionTypeInstance struct {
	...
	ChannelDim float64  `json:"channel_dim"`
}
...
// GetChannelDim returns the ChannelDim field value
...
// GetChannelDimOk returns a tuple with the ChannelDim field value
// and a boolean to check if the value has been set.
...
// SetChannelDim sets field value
