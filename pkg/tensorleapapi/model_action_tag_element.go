...
type _ActionTagElement ActionTagElement
...
func (o *ActionTagElement) UnmarshalJSON(data []byte) (err error) {
	...
	varActionTagElement := _ActionTagElement{}

	err = json.Unmarshal(data, &varActionTagElement)

	if err != nil {
		return err
	}

	*o = ActionTagElement(varActionTagElement)
