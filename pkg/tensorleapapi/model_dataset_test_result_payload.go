...
type _DatasetTestResultPayload DatasetTestResultPayload
...
func (o *DatasetTestResultPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varDatasetTestResultPayload := _DatasetTestResultPayload{}

	err = json.Unmarshal(data, &varDatasetTestResultPayload)

	if err != nil {
		return err
	}

	*o = DatasetTestResultPayload(varDatasetTestResultPayload)
