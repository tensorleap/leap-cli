...
type _SessionWeightData SessionWeightData
...
func (o *SessionWeightData) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionWeightData := _SessionWeightData{}

	err = json.Unmarshal(data, &varSessionWeightData)

	if err != nil {
		return err
	}

	*o = SessionWeightData(varSessionWeightData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "globalStep")
