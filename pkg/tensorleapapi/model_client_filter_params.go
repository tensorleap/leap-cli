...
type _ClientFilterParams ClientFilterParams
...
func (o *ClientFilterParams) UnmarshalJSON(data []byte) (err error) {
	...
	varClientFilterParams := _ClientFilterParams{}

	err = json.Unmarshal(data, &varClientFilterParams)

	if err != nil {
		return err
	}

	*o = ClientFilterParams(varClientFilterParams)
