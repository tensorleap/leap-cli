...
type _LoadVersionParams LoadVersionParams
...
func (o *LoadVersionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varLoadVersionParams := _LoadVersionParams{}

	err = json.Unmarshal(data, &varLoadVersionParams)

	if err != nil {
		return err
	}

	*o = LoadVersionParams(varLoadVersionParams)
