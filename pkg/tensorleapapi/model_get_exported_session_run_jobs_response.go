...
type GetExportedSessionRunJobsResponse struct {
	ExportedSessionRunJobs []ExportedSessionRunJobUi `json:"exportedSessionRunJobs"`
}
...
func NewGetExportedSessionRunJobsResponse(exportedSessionRunJobs []ExportedSessionRunJobUi) *GetExportedSessionRunJobsResponse {
	...
	this.ExportedSessionRunJobs = exportedSessionRunJobs
	return &this
}
...
// GetExportedSessionRunJobs returns the ExportedSessionRunJobs field value
func (o *GetExportedSessionRunJobsResponse) GetExportedSessionRunJobs() []ExportedSessionRunJobUi {
	if o == nil {
		var ret []ExportedSessionRunJobUi
		return ret
	}

	return o.ExportedSessionRunJobs
}

// GetExportedSessionRunJobsOk returns a tuple with the ExportedSessionRunJobs field value
// and a boolean to check if the value has been set.
func (o *GetExportedSessionRunJobsResponse) GetExportedSessionRunJobsOk() ([]ExportedSessionRunJobUi, bool) {
	if o == nil {
		return nil, false
	}
	return o.ExportedSessionRunJobs, true
}

// SetExportedSessionRunJobs sets field value
func (o *GetExportedSessionRunJobsResponse) SetExportedSessionRunJobs(v []ExportedSessionRunJobUi) {
	o.ExportedSessionRunJobs = v
}
...
func (o GetExportedSessionRunJobsResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["exportedSessionRunJobs"] = o.ExportedSessionRunJobs
