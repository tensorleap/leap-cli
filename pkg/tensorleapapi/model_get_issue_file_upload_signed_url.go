...
type _GetIssueFileUploadSignedUrl GetIssueFileUploadSignedUrl
...
func (o *GetIssueFileUploadSignedUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varGetIssueFileUploadSignedUrl := _GetIssueFileUploadSignedUrl{}

	err = json.Unmarshal(data, &varGetIssueFileUploadSignedUrl)

	if err != nil {
		return err
	}

	*o = GetIssueFileUploadSignedUrl(varGetIssueFileUploadSignedUrl)
