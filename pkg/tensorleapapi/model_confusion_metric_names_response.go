...
type _ConfusionMetricNamesResponse ConfusionMetricNamesResponse
...
func (o *ConfusionMetricNamesResponse) UnmarshalJSON(data []byte) (err error) {
	// This validates that all required properties are included in the JSON object
	// by unmarshalling the object into a generic map with string keys and checking
	// that every required field exists as a key in the generic map.
	requiredProperties := []string{
		"confusionMetricNames",
	}
	...
	varConfusionMetricNamesResponse := _ConfusionMetricNamesResponse{}

	err = json.Unmarshal(data, &varConfusionMetricNamesResponse)

	if err != nil {
		return err
	}

	*o = ConfusionMetricNamesResponse(varConfusionMetricNamesResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "confusionMetricNames")
