...
type _GetTeamsResponse GetTeamsResponse
...
func (o *GetTeamsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTeamsResponse := _GetTeamsResponse{}

	err = json.Unmarshal(data, &varGetTeamsResponse)

	if err != nil {
		return err
	}

	*o = GetTeamsResponse(varGetTeamsResponse)
