...
type Dashboard struct {
	...
	IgnoreSuggestedDashletsHashes []string  `json:"ignoreSuggestedDashletsHashes"`
...
func NewDashboard(cid string, projectId string, createdAt time.Time, updatedAt time.Time, createdBy string, name string, items []Dashlet, ignoreSuggestedDashletsHashes []string) *Dashboard {
	...
	this.Name = name
	this.Items = items
	this.IgnoreSuggestedDashletsHashes = ignoreSuggestedDashletsHashes
	return &this
}
...
// GetIgnoreSuggestedDashletsHashes returns the IgnoreSuggestedDashletsHashes field value
...
// GetIgnoreSuggestedDashletsHashesOk returns a tuple with the IgnoreSuggestedDashletsHashes field value
// and a boolean to check if the value has been set.
...
// SetIgnoreSuggestedDashletsHashes sets field value
