...
type _TerminateJobResponse TerminateJobResponse
...
func (o *TerminateJobResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTerminateJobResponse := _TerminateJobResponse{}

	err = json.Unmarshal(data, &varTerminateJobResponse)

	if err != nil {
		return err
	}

	*o = TerminateJobResponse(varTerminateJobResponse)
