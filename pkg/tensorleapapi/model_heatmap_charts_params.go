...
type _HeatmapChartsParams HeatmapChartsParams
...
func (o *HeatmapChartsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varHeatmapChartsParams := _HeatmapChartsParams{}

	err = json.Unmarshal(data, &varHeatmapChartsParams)

	if err != nil {
		return err
	}

	*o = HeatmapChartsParams(varHeatmapChartsParams)
