...
type _PopExploreInfo PopExploreInfo
...
func (o *PopExploreInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varPopExploreInfo := _PopExploreInfo{}

	err = json.Unmarshal(data, &varPopExploreInfo)

	if err != nil {
		return err
	}

	*o = PopExploreInfo(varPopExploreInfo)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "population_exploration_n_samples")
