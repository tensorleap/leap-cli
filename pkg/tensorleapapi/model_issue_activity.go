...
type _IssueActivity IssueActivity
...
func (o *IssueActivity) UnmarshalJSON(data []byte) (err error) {
	...
	varIssueActivity := _IssueActivity{}

	err = json.Unmarshal(data, &varIssueActivity)

	if err != nil {
		return err
	}

	*o = IssueActivity(varIssueActivity)
