...
type _GetMachineTypesResponse GetMachineTypesResponse
...
func (o *GetMachineTypesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMachineTypesResponse := _GetMachineTypesResponse{}

	err = json.Unmarshal(data, &varGetMachineTypesResponse)

	if err != nil {
		return err
	}

	*o = GetMachineTypesResponse(varGetMachineTypesResponse)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "options")
		delete(additionalProperties, "defaultCpuType")
		delete(additionalProperties, "defaultGpuType")
