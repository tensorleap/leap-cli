...
type _ValueWithKey ValueWithKey
...
func (o *ValueWithKey) UnmarshalJSON(data []byte) (err error) {
	...
	varValueWithKey := _ValueWithKey{}

	err = json.Unmarshal(data, &varValueWithKey)

	if err != nil {
		return err
	}

	*o = ValueWithKey(varValueWithKey)
