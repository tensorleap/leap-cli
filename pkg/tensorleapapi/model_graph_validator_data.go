...
type GraphValidatorData struct {
	...
	CustomLayers          []ValidatedNode        `json:"custom_layers"`
	AvailableLatentSpaces []AvailableLatentSpace `json:"available_latent_spaces"`
	GeneralError          *string                `json:"general_error,omitempty"`
	AdditionalProperties  map[string]interface{}
}

type _GraphValidatorData GraphValidatorData
...
func NewGraphValidatorData(inputs []ValidatedNode, metadata []ValidatedNode, groundTruths []ValidatedNode, predictionTypes []ValidatedNode, visualizers []ValidatedNode, losses []ValidatedLossNode, metrics []ValidatedNode, customLayers []ValidatedNode, availableLatentSpaces []AvailableLatentSpace) *GraphValidatorData {
	...
	this.AvailableLatentSpaces = availableLatentSpaces
	return &this
}
...
// GetAvailableLatentSpaces returns the AvailableLatentSpaces field value
func (o *GraphValidatorData) GetAvailableLatentSpaces() []AvailableLatentSpace {
	if o == nil {
		var ret []AvailableLatentSpace
		return ret
	}
...
// GetAvailableLatentSpacesOk returns a tuple with the AvailableLatentSpaces field value
// and a boolean to check if the value has been set.
...
// SetAvailableLatentSpaces sets field value
...
func (o *GraphValidatorData) UnmarshalJSON(data []byte) (err error) {
	...
	varGraphValidatorData := _GraphValidatorData{}

	err = json.Unmarshal(data, &varGraphValidatorData)

	if err != nil {
		return err
	}

	*o = GraphValidatorData(varGraphValidatorData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "losses")
		delete(additionalProperties, "metrics")
		delete(additionalProperties, "custom_layers")
		delete(additionalProperties, "available_latent_spaces")
		delete(additionalProperties, "general_error")
