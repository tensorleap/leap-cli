...
type _CreateEquivalentValidationParams CreateEquivalentValidationParams
...
func (o *CreateEquivalentValidationParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateEquivalentValidationParams := _CreateEquivalentValidationParams{}

	err = json.Unmarshal(data, &varCreateEquivalentValidationParams)

	if err != nil {
		return err
	}

	*o = CreateEquivalentValidationParams(varCreateEquivalentValidationParams)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "targetDigest")
