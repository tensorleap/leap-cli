...
type _VisualizedItem VisualizedItem
...
func (o *VisualizedItem) UnmarshalJSON(data []byte) (err error) {
	...
	varVisualizedItem := _VisualizedItem{}

	err = json.Unmarshal(data, &varVisualizedItem)

	if err != nil {
		return err
	}

	*o = VisualizedItem(varVisualizedItem)
