...
type _GetGeneratedDashletsBySessionRun GetGeneratedDashletsBySessionRun
...
func (o *GetGeneratedDashletsBySessionRun) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGeneratedDashletsBySessionRun := _GetGeneratedDashletsBySessionRun{}

	err = json.Unmarshal(data, &varGetGeneratedDashletsBySessionRun)

	if err != nil {
		return err
	}

	*o = GetGeneratedDashletsBySessionRun(varGetGeneratedDashletsBySessionRun)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "dashlets")
