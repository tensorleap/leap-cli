## leap server tools kubectl create service externalname
...
```
leap server tools kubectl create service externalname NAME --external-name external.name [--dry-run=server|client|none]
```
