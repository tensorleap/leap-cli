## leap server tools kubectl create service nodeport
...
```
leap server tools kubectl create service nodeport NAME [--tcp=port:targetPort] [--dry-run=server|client|none]
```
