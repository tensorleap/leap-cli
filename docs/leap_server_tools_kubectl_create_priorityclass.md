## leap server tools kubectl create priorityclass
...
```
leap server tools kubectl create priorityclass NAME --value=VALUE --global-default=BOOL [--dry-run=server|client|none]
```
