## leap server tools kubectl cluster-info
...
```
leap server tools kubectl cluster-info [flags]
```
...
* [leap server tools kubectl cluster-info dump](leap_server_tools_kubectl_cluster-info_dump.md)	 - Dump relevant information for debugging and diagnosis
