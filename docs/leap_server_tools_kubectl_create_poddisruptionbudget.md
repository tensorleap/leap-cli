## leap server tools kubectl create poddisruptionbudget
...
```
leap server tools kubectl create poddisruptionbudget NAME --selector=SELECTOR --min-available=N [--dry-run=server|client|none]
```
