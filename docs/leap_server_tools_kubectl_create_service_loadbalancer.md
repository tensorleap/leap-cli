## leap server tools kubectl create service loadbalancer
...
```
leap server tools kubectl create service loadbalancer NAME [--tcp=port:targetPort] [--dry-run=server|client|none]
```
