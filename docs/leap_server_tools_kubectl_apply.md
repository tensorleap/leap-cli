## leap server tools kubectl apply
...
```
leap server tools kubectl apply (-f FILENAME | -k DIRECTORY)
```
...
* [leap server tools kubectl apply edit-last-applied](leap_server_tools_kubectl_apply_edit-last-applied.md)	 - Edit latest last-applied-configuration annotations of a resource/object
* [leap server tools kubectl apply set-last-applied](leap_server_tools_kubectl_apply_set-last-applied.md)	 - Set the last-applied-configuration annotation on a live object to match the contents of a file
* [leap server tools kubectl apply view-last-applied](leap_server_tools_kubectl_apply_view-last-applied.md)	 - View the latest last-applied-configuration annotations of a resource/object
